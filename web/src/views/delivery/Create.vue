<template>
  <div class="main">
    ...
    <div class="steps-content">
      <div v-if="current === 0">
        <a-form-model :model="form" :label-col="labelCol" :wrapper-col="wrapperCol">
          ...
          <a-form-model-item label="预计交货时间" required>
            <a-date-picker :locale="locale" v-model="form.time" show-time type="date" placeholder="选择日期"
              style="width: 100%;" />
          </a-form-model-item>
      ...
      <div v-if="current === 2">
        <a-result status="success" title="提交成功" sub-title="请前往配送列表页面进行审批">
          <template #extra>
