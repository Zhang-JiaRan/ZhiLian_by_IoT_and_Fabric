...
const routes = [

    {
        ...
        children: [
            ...
            {
                path: 'shouye',
                component: () => import('@/views/basics/shouye'),
                meta: { auth: true }
            },
            {
                path: 'commodity',
            ...
            {
                path: 'delivery/KEZHUISU',
                component: () => import('@/views/delivery/KEZHUISU'),
                meta: { auth: true }
            },
            {
                path: 'delivery/fankuichuli',
                component: () => import('@/views/delivery/fankuichuli'),
                meta: { auth: true }
            },
            {
                path: '/tracking',
                component: () => import('@/views/basics/tracking'),
                meta: { auth: true }
            },
            {
                path: '/lujingguihua',
                component: () => import('@/views/basics/lujingguihua'),
                meta: { auth: true }
            },
            {
                path: '/tanpaifang',
                component: () => import('@/views/basics/tanpaifang'),
                meta: { auth: true }
            },
            {
                path: 'analyze/in',
